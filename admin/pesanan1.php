                            ...
                            <?php foreach ($result as $result) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="detailpesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary" style="color: black;">Detail</a>


                                        <a onclick="return confirm('Apakah anda ingin Hapus ?');" href="clear_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-danger" style="color: black;">Hapus Data</a>
                                    </td>
                                </tr>
                                <?php $nomor++; ?>
                            <?php endforeach; ?>
